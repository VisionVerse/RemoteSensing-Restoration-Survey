...
- **2026/3/9**: Our paper has been officially published in the [ISPRS Journal of Photogrammetry and Remote Sensing](). The preprint version is available on [arXiv]().
...
41 | 2025 |ThiefCloud | TCSVT |ThiefCloud: A Thickness Fused Thin Cloud Removal Network for Optical Remote Sensing Image With Self-Supervised Learnable Cloud Prior | [Paper](https://ieeexplore.ieee.org/abstract/document/11071276)/[Project](https://github.com/lixinghua5540/ThiefCloud)
...
22 | 2025 | HSFormer | TGRS | HSFormer: Multiscale Hybrid Sparse Transformer for Uncertainty-Aware Cloud and Shadow Removal |[Paper](https://ieeexplore.ieee.org/abstract/document/10978072)/[Project]
23 | 2026 | GPNet | JSTARS | Gradient-aware Physics-guided Network for Remote Sensing Image Dehazing |[Paper](https://ieeexplore.ieee.org/abstract/document/11421024)/[Project]
